...
export const menu = [
  ...
  },
  {
    ...
    ingredients:
      'Reclamações trabalhistas, rescisões, acordos, defesas',
    category: 'starters',
  ...
  },
  {
    ...
    ingredients:
      'Contratos, constituição de empresas, recuperação judicial',
    category: 'specialty',
  ...
  },
  {
    ...
    ingredients:
      'Contratos de compra e venda, locação, regularização de imóveis',
    category: 'specialty',
...
export const specials = [
  {
    ...
    content:
      'A Glauco Advocacia se destaca pela dedicação ao cliente e pela busca constante de soluções atualizadas e alinhadas à legislação, garantindo segurança em cada processo.',
    active: true,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    subtitle:
      'Atuação ética e transparente para resguardar direitos trabalhistas',
    content:
      'Nossa equipe está preparada para defender profissionais e empregadores em questões trabalhistas, sempre priorizando a justiça e o equilíbrio nas relações de trabalho.',
    active: false,
  },
  {
    id: 4,
    ...
    title:
      'Direito de Família com Sensibilidade',
    subtitle:
      'Atendimento humanizado em momentos delicados de vida',
    content:
      'Na Glauco Advocacia, acolhemos cada caso de família com respeito, buscando sempre resoluções equilibradas e que respeitam os interesses de todos.',
    active: false,
  },
  {
    id: 5,
    ...
    content:
      'Da constituição à reestruturação empresarial, oferecemos suporte completo para empresas crescerem de forma segura e sustentável.',
    active: false,
  },
];
